/**
 * @file <e-puck_leader/simulator/qtopengl_epuckleader.cpp>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#include "qtopengl_epuckleader.h"
...
namespace argos {
   ...
   CQTOpenGLEPuckLeader::CQTOpenGLEPuckLeader() :
      m_unVertices(40),
   ...
   void CQTOpenGLEPuckLeader::Draw(CEPuckLeaderEntity& c_entity) {
      /* Place the chassis */
   ...
   void CQTOpenGLEPuckLeader::SetGreenPlasticMaterial() {
   ...
   void CQTOpenGLEPuckLeader::SetRedPlasticMaterial() {
   ...
   void CQTOpenGLEPuckLeader::SetCircuitBoardMaterial() {
   ...
   void CQTOpenGLEPuckLeader::SetLEDMaterial(GLfloat f_red,
                                       GLfloat f_green,
                                       GLfloat f_blue) {
   ...
   void CQTOpenGLEPuckLeader::RenderWheel() {
      /* Set material */
   ...
   void CQTOpenGLEPuckLeader::RenderLED() {
      /* Side surface */
      CVector2 cVertex(BODY_RADIUS, 0.0f);
      CRadians cAngle(CRadians::TWO_PI / m_unVertices);
      CVector2 cNormal(1.0f, 0.0f);
   ...
   class CQTOpenGLOperationDrawEPuckLeaderNormal : public CQTOpenGLOperationDrawNormal {
   public:
      void ApplyTo(CQTOpenGLWidget& c_visualization,
                   CEPuckLeaderEntity& c_entity) {
         static CQTOpenGLEPuckLeader m_cModel;
   ...
   class CQTOpenGLOperationDrawEPuckLeaderSelected : public CQTOpenGLOperationDrawSelected {
   public:
      void ApplyTo(CQTOpenGLWidget& c_visualization,
                   CEPuckLeaderEntity& c_entity) {
   ...
   REGISTER_QTOPENGL_ENTITY_OPERATION(CQTOpenGLOperationDrawNormal, CQTOpenGLOperationDrawEPuckLeaderNormal, CEPuckLeaderEntity);

   REGISTER_QTOPENGL_ENTITY_OPERATION(CQTOpenGLOperationDrawSelected, CQTOpenGLOperationDrawEPuckLeaderSelected, CEPuckLeaderEntity);

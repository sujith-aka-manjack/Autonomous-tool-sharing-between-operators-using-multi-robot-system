/**
 * @file <argos3/plugins/robots/generic/control_interface/ci_epuckpos_proximity_sensor.cpp>
 *
 * @author Danesh Tarapore <daneshtarapore@gmail.com>
 */

#include "ci_epuckpos_proximity_sensor.h"
...
namespace argos 
{
   ...
   CCI_EPuckPosProximitySensor::CCI_EPuckPosProximitySensor() :
      m_tReadings(8)
   {
...
#ifdef ARGOS_WITH_LUA
   void CCI_EPuckPosProximitySensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_EPuckPosProximitySensor::ReadingsToLuaState(lua_State* pt_lua_state) {
   ...
   std::ostream& operator<<(std::ostream& c_os,
                            const CCI_EPuckPosProximitySensor::SReading& s_reading) {
   ...
   std::ostream& operator<<(std::ostream& c_os,
                            const CCI_EPuckPosProximitySensor::TReadings& t_readings) {
      if(! t_readings.empty()) {

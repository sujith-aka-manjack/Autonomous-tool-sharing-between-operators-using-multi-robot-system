/**
 * @file <argos3/plugins/simulator/sensors/epuckpos_proximity_default_sensor.h>
 *
 * @author Danesh Tarapore - <daneshtarapore@gmail.com>
 */

#ifndef EPUCKPOS_PROXIMITY_DEFAULT_SENSOR_H
#define EPUCKPOS_PROXIMITY_DEFAULT_SENSOR_H

#include <string>
#include <map>

namespace argos {
   class CEPuckPosProximityDefaultSensor;
   class CProximitySensorEquippedEntity;
}

#include <epuckpos/control_interface/ci_epuckpos_proximity_sensor.h>
...
namespace argos {
   ...
   class CEPuckPosProximityDefaultSensor : public CSimulatedSensor,
                                   public CCI_EPuckPosProximitySensor {

   public:

      CEPuckPosProximityDefaultSensor();

      virtual ~CEPuckPosProximityDefaultSensor() {}

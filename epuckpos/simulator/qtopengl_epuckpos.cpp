/**
 * @file <epuckpos/simulator/qtopengl_epuckpos.cpp>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#include "qtopengl_epuckpos.h"
...
namespace argos {
   ...
   CQTOpenGLEPuckPos::CQTOpenGLEPuckPos() :
      m_unVertices(40),
   ...
   void CQTOpenGLEPuckPos::Draw(CEPuckPosEntity& c_entity) {
      /* Place the chassis */
   ...
   void CQTOpenGLEPuckPos::SetGreenPlasticMaterial() {
   ...
   void CQTOpenGLEPuckPos::SetRedPlasticMaterial() {
   ...
   void CQTOpenGLEPuckPos::SetCircuitBoardMaterial() {
   ...
   void CQTOpenGLEPuckPos::SetLEDMaterial(GLfloat f_red,
                                       GLfloat f_green,
                                       GLfloat f_blue) {
   ...
   void CQTOpenGLEPuckPos::RenderWheel() {
      /* Set material */
   ...
   void CQTOpenGLEPuckPos::RenderChassis() {
      /* Set material */
   ...
   void CQTOpenGLEPuckPos::RenderBody() {
      /* Set material */
      SetGreenPlasticMaterial();
   ...
   void CQTOpenGLEPuckPos::RenderLED() {
      /* Side surface */
      CVector2 cVertex(BODY_RADIUS, 0.0f);
      CRadians cAngle(CRadians::TWO_PI / m_unVertices);
      CVector2 cNormal(1.0f, 0.0f);
   ...
   class CQTOpenGLOperationDrawEPuckPosNormal : public CQTOpenGLOperationDrawNormal {
   public:
      void ApplyTo(CQTOpenGLWidget& c_visualization,
                   CEPuckPosEntity& c_entity) {
         static CQTOpenGLEPuckPos m_cModel;
   ...
   class CQTOpenGLOperationDrawEPuckPosSelected : public CQTOpenGLOperationDrawSelected {
   public:
      void ApplyTo(CQTOpenGLWidget& c_visualization,
                   CEPuckPosEntity& c_entity) {
   ...
   REGISTER_QTOPENGL_ENTITY_OPERATION(CQTOpenGLOperationDrawNormal, CQTOpenGLOperationDrawEPuckPosNormal, CEPuckPosEntity);

   REGISTER_QTOPENGL_ENTITY_OPERATION(CQTOpenGLOperationDrawSelected, CQTOpenGLOperationDrawEPuckPosSelected, CEPuckPosEntity);

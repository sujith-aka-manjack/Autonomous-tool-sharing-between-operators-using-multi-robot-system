/**
 * @file <epuckpos/simulator/epuckpos_entity.h>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#ifndef EPUCKPOS_ENTITY_H
#define EPUCKPOS_ENTITY_H
...
namespace argos {
   ...
   class CEPuckPosEntity : public CComposableEntity {
   ...
   public:
      ...
      CEPuckPosEntity(const std::string& str_id,

...
Devices['YAML'] = letk.Class( Devices['base'] ):init_options()
Devices['YAML'].template_file = 'controller.yaml'
Devices['YAML'].display = true
Devices['YAML'].name = "YAML"

--*********************************++*********************************--
--**                      YAML PROBABILISTIC                        **--
--********************************************************************--

Devices['YAMLProb'] = letk.Class( Devices['base'] ):init_options()
Devices['YAMLProb'].template_file = 'controller_prob.yaml'
Devices['YAMLProb'].display = true
Devices['YAMLProb'].name = "YAML Probabilistic"

--*********************************++*********************************--
--**                          YAML PUBLIC                           **--
--********************************************************************--

Devices['YAMLPublic'] = letk.Class( Devices['base'] ):init_options()
Devices['YAMLPublic'].template_file = 'controller_public.yaml'
Devices['YAMLPublic'].display = true
Devices['YAMLPublic'].name = "YAML Public"

--*********************************++*********************************--
--**                 YAML PROBABILISTIC AND PUBLIC                  **--
--********************************************************************--

Devices['YAMLProbPublic'] = letk.Class( Devices['base'] ):init_options()
Devices['YAMLProbPublic'].template_file = 'controller_prob_public.yaml'
Devices['YAMLProbPublic'].display = true
Devices['YAMLProbPublic'].name = "YAML Probabilistic and Public"

--*********************************++*********************************--
--**                     VARIABLE PROBABILISTIC                     **--
--********************************************************************--

Devices['CPPVarProb'] = letk.Class( Devices['base'] ):init_options()
Devices['CPPVarProb'].template_file = 'controller_prob.h'
Devices['CPPVarProb'].display = true
Devices['CPPVarProb'].name = "C++ Variable Probability"

--*********************************++*********************************--
--**                     VARIABLE PROBABILISTIC                     **--
--********************************************************************--

Devices['CPPPub'] = letk.Class( Devices['base'] ):init_options()
Devices['CPPPub'].template_file = 'controller_pub.h'
Devices['CPPPub'].display = true
Devices['CPPPub'].name = "C++ Public"

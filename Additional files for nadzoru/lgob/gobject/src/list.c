...
static int lgob_gstrv2table(lua_State* L)
{
    ...
    for(i = 0; i < length; ++i)
    {
        ...
        #ifdef IDEBUG
        fprintf(stderr, "Iterating: i == %i and value == %s\n", i, value);
        #endif
    ...
    #ifdef IDEBUG
    fprintf(stderr, "Returning a GStrv with %i elements!\n", i);
    #endif
...
static int lgob_table2gstrv(lua_State* L)
{
    ...
    for (;;)
    {
        ...
        #ifdef IDEBUG
        fprintf(stderr, "Iterating: i == %i, type == %s\n", i, lua_typename(L, lua_type(L, -1)));
        #endif
...
static int lgob_gslist2table(lua_State* L)
{
    ...
    #ifdef IDEBUG
    fprintf(stderr, "Returning a table with %i elements!\n", i);
    #endif

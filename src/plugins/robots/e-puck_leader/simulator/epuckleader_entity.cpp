/**
 * @file <e-puck_leader/simulator/epuckleader_entity.cpp>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#include "epuckleader_entity.h"
...
namespace argos {
   ...
   CEPuckLeaderEntity::CEPuckLeaderEntity() :
   ...
   CEPuckLeaderEntity::CEPuckLeaderEntity(const std::string& str_id,
   ...
   void CEPuckLeaderEntity::Init(TConfigurationNode& t_tree) {
      try {
         /*
          * Init parent
          */
   ...
   void CEPuckLeaderEntity::Destroy() {
...
#define UPDATE(COMPONENT) if(COMPONENT->IsEnabled()) COMPONENT->Update();
   ...
   void CEPuckLeaderEntity::UpdateComponents() {
   ...
   REGISTER_ENTITY(CEPuckLeaderEntity,
                   "e-puck_leader",
                   "Carlo Pinciroli [ilpincy@gmail.com]",
                   "1.0",
                   "The e-puck_leader robot.",
                   "The e-puck_leader is a open-hardware, extensible robot intended for education. In its\n"
                   ...
                   "red LEDs. More information is available at http://www.epuckleader.org\n\n"
                   "REQUIRED XML CONFIGURATION\n\n"
                   "  <arena ...>\n"
                   "    ...\n"
                   "    <e-puck_leader id=\"eb0\">\n"
                   ...
                   "e-puck_leader in the arena. When the robot is untranslated and unrotated, the\n"
                   ...
                   "The 'body/orientation' attribute specifies the orientation of the e-puck_leader. All\n"
                   ...
                   "e-puck_leader. The value of the attribute must be set to the id of a previously\n"
                   "defined controller. Controllers are defined in the <controllers> XML subtree.\n\n"
                   "OPTIONAL XML CONFIGURATION\n\n"
                   "You can set the emission range of the range-and-bearing system. By default, a\n"
                   "message sent by an e-puck_leader can be received up to 80cm. By using the 'rab_range'\n"
                   "attribute, you can change it to, i.e., 4m as follows:\n\n"
                   "  <arena ...>\n"
                   "    ...\n"
                   "    <e-puck_leader id=\"eb0\" rab_range=\"4\">\n"
                   "      <body position=\"0.4,2.3,0.25\" orientation=\"45,90,0\" />\n"
                   "      <controller config=\"mycntrl\" />\n"
                   "    </e-puck_leader>\n"
                   "    ...\n"
                   ...
                   "system. By default, a message sent by an e-puck_leader is 2 bytes long. By using the\n"
                   "'rab_data_size' attribute, you can change it to, i.e., 20 bytes as follows:\n\n"
                   "  <arena ...>\n"
                   "    ...\n"
                   "    <e-puck_leader id=\"eb0\" rab_data_size=\"20\">\n"
                   "      <body position=\"0.4,2.3,0.25\" orientation=\"45,90,0\" />\n"
                   "      <controller config=\"mycntrl\" />\n"
                   "    </e-puck_leader>\n"
                   "    ...\n"
   ...
   REGISTER_STANDARD_SPACE_OPERATIONS_ON_COMPOSABLE(CEPuckLeaderEntity);

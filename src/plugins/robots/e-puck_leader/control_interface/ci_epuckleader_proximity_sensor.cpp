/**
 * @file <argos3/plugins/robots/generic/control_interface/ci_epuckleader_proximity_sensor.cpp>
 *
 * @author Danesh Tarapore <daneshtarapore@gmail.com>
 */

#include "ci_epuckleader_proximity_sensor.h"
...
namespace argos 
{
   ...
   CCI_EPuckLeaderProximitySensor::CCI_EPuckLeaderProximitySensor() :
      m_tReadings(8)
   {
...
#ifdef ARGOS_WITH_LUA
   void CCI_EPuckLeaderProximitySensor::CreateLuaState(lua_State* pt_lua_state) {
...
#ifdef ARGOS_WITH_LUA
   void CCI_EPuckLeaderProximitySensor::ReadingsToLuaState(lua_State* pt_lua_state) {
   ...
   std::ostream& operator<<(std::ostream& c_os,
                            const CCI_EPuckLeaderProximitySensor::SReading& s_reading) {
   ...
   std::ostream& operator<<(std::ostream& c_os,
                            const CCI_EPuckLeaderProximitySensor::TReadings& t_readings) {
      if(! t_readings.empty()) {

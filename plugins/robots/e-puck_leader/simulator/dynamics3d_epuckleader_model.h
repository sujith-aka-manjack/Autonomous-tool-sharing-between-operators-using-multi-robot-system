/**
 * @file <e-puck_leader/simulator/dynamics3d_epuckleader_model.h>
 *
 * @author Michael Allwright - <allsey87@gmail.com>
 */

#ifndef DYNAMICS3D_EPUCKLEADER_MODEL_H
#define DYNAMICS3D_EPUCKLEADER_MODEL_H

namespace argos {
   class CDynamics3DEPuckLeaderModel;
...
namespace argos {
   ...
   class CDynamics3DEPuckLeaderModel : public CDynamics3DMultiBodyObjectModel {

   public:     

      CDynamics3DEPuckLeaderModel(CDynamics3DEngine& c_engine,
                            CEPuckLeaderEntity& c_epuckleader);

      virtual ~CDynamics3DEPuckLeaderModel() {}
